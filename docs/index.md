...
This library is not affiliated with GME ([Gestore dei Mercati Energetici S.p.A.](https://mercatoelettrico.org/It/Default.aspx)) in any way. It is provided as is, without any warranty. All data belongs to GME and cannot be used for profit. Terms of use can be found [here](https://www.mercatoelettrico.org/it/tools/AccessoDati.aspx).
